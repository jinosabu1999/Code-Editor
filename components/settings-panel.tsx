...
export default function SettingsPanel({ isOpen, onClose, theme }: SettingsPanelProps) {
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-0 z-50 ${theme.bg} ${theme.text} md:absolute md:inset-auto md:right-0 md:top-0 md:h-full md:w-80 ${theme.primary} ${theme.border} shadow-2xl overflow-auto backdrop-blur-3xl bg-card/95`}
      >
        <div className="p-4">
